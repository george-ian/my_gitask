...
print("investment - to calculate the amount of interest you will earn on "
                                                    "your investment")
print('*'*82)
print("bond - to calculate the monthly amount that you will have to pay "
                                                    "on a home loan")
print('*'*82)
...
try:
    if user_sel.casefold() == "bond" or user_sel.casefold() =="investment":
        ...
        if user_sel.casefold() =="investment":
            ...
            deposit = int(input("Enter the amount of money that"
                                        "you are depositing: "))
            ...
            print(f"The total amount you will get back is: \n{round(total)}")
            

        else:
            present_value = int(input("Enter the present value of the house: "))
            int_rate = int(input("Enter the number of the interest rate: "))
            n = int(input("Please enter for how many months you are planning "
                                                    "to repay the bond: "))
        ...
        print("Invalid selection! Enter either 'investment' or 'bond'"
