...
print('*'*82)
print("bond - to calculate the monthly amount that you will have to pay on a home loan")
print('*'*82)

user_sel = input("Enter either 'investment' or 'bond' from the menu above to proceed:\n")
...
try:
    if user_sel.casefold() == "bond" or user_sel.casefold() =="investment":
        ...
        if user_sel.casefold() =="investment":
            ...
            number_years = int(input("Enter for how many years you are depositing: "))
            ...
            if interest =="compound":
                ...
                print("Invalid user selection! Please enter simple or compound:\n")
            ...
            int_rate = int(input("Enter the number of the interest rate: "))
            n = int(input("Enter for how many months you are planning to repay the bond: "))
        ...
        print("Invalid selection! Enter either 'investment' or 'bond' from the menu above to proceed:")
